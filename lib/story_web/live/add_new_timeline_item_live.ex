    ...
    <div class="timeline-item add-new">
      ...
      <div id="item-new-content">
        ...
        <div class="grid grid-cols-4 gap-4 max-w-full">
          <a class="text-center text-neutral text-xs" href="#" phx-click="show-form" phx-value-type="position" phx-value-form="position" phx-target={@myself}>
          ...
          <a class="text-center text-neutral text-xs" href="#" phx-click="show-form" phx-value-type="blogs_or_videos" phx-value-form="blogs_or_videos" phx-target={@myself}>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline" viewBox="0 0 20 20" fill="currentColor">
          ...
          <a class="text-center text-neutral text-xs" href="#" phx-click="show-form" phx-value-type="open_source" phx-value-form="open_source" phx-target={@myself}>
          ...
          <a class="text-center text-neutral text-xs" href="#" phx-click="show-form" phx-value-type="feature_or_apps" phx-value-form="feature_or_apps" phx-target={@myself}>
            <svg xmlns="http://www.w3.org/2000/svg" class="inline h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <a class="text-center text-neutral text-xs" href="#" phx-click="show-form" phx-value-type="education" phx-value-form="education" phx-target={@myself}>
            <svg xmlns="http://www.w3.org/2000/svg" class="inline h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <a class="text-center text-neutral text-xs" href="#" phx-click="show-form" phx-value-type="certification" phx-value-form="default"  phx-target={@myself}>
            <svg xmlns="http://www.w3.org/2000/svg" class="inline h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <a class="text-center text-neutral text-xs" href="#" phx-click="show-form" phx-value-type="milestone" phx-value-form="default" phx-target={@myself}>
            <svg xmlns="http://www.w3.org/2000/svg" class="inline h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <a class="text-center text-neutral text-xs" href="#" phx-click="show-form" phx-value-type="assessment" phx-value-form="assessment" phx-target={@myself}>
            <svg xmlns="http://www.w3.org/2000/svg" class="inline h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
